...
DEFINE ('_CURRENCY_ADP', 'Andorrianische Peseta');
...
DEFINE ('_CURRENCY_BEF', 'Belgische Franc');
...
DEFINE ('_CURRENCY_CZK', 'Tschechische Koruna');
...
DEFINE ('_CURRENCY_EGP', '&Auml;gyptische Pound');
...
DEFINE ('_CURRENCY_LBP', 'Libanesisches Pound');
...
DEFINE ('_CURRENCY_LUF', 'Luxemburgische Franc');
...
DEFINE ('_CURRENCY_NLG', 'Niederl&auml;ndische Gulden');
...
DEFINE ('_CURRENCY_PTE', 'Portugiesische Escudo');
...
DEFINE ('_CURRENCY_SKK', 'Slovakische Koruna');
...
DEFINE ('_CURRENCY_RUR', 'Russische Ruble');
