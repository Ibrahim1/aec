...
define( '_CFG_TAB1_OPT1NAME', 'Periodo de expiracion inicial:');
define( '_CFG_TAB1_OPT1DESC', 'Tiempo de expiracin por defecto para nuevas registraciones. Esto es relativo a la fecha de registracion. Si quiere que los nuevos usuarios expiren por defecto utilice -1 aqui. Esto no tiene efecto cuando se utiliza un sistema de pago. (e.j. integracion con PayPal).');
