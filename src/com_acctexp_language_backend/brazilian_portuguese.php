<?php
/**
* @version $Id: brazilian_portuguese.php 16 2007-06-25 09:04:04Z mic $
...
define( '_REMOVE','Mover para Excludos');
define( '_CNAME','Nome');
define( '_USERLOGIN','Login de usurio');
define( '_EXPIRATION','Expiraco');
define( '_USERS','Usurios');
define( '_DISPLAY','Mostrar');
define( '_NOTSET','Excludo');
define( '_SAVE','Salvar');
define( '_CANCEL','Cancelar');
define( '_EXP_ASC','Expiraco Asc');
define( '_EXP_DESC','Expiraco Desc');
...
define( '_EOT_DESC', 'Esta lista nao inclui assinaturas configuradas manualmente, apenas as processadas pelo PayPal. Ao remover uma entrada, o usurio  removido da base assim como todas as suas entradas na tabela local de histrico de atividades do PayPal.');
define( '_EOT_DATE', 'Encerramento da Assinatura');
define( '_EOT_CAUSE', 'Causa');
define( '_EOT_CAUSE_FAIL', 'Falha no Pagamento');
define( '_EOT_CAUSE_BUYER', 'Cancelado pelo usurio');
define( '_EOT_CAUSE_FORCED', 'Cancelado pelo administrador');
define( '_REMOVE_CLOSED', 'Remover Usurio');
define( '_FORCE_CLOSE', 'Encerrar Assinatura');
...
define( '_PAYPLAN_P3', 'Perodo');
define( '_PAYPLAN_T3', 'Unidade');
define( '_PAYPLAN_USERCOUNT', 'Assinantes');
...
define( '_ALTERNATIVE_PAYMENT', 'Transferncia Bancria');
define( '_SUBSCR_DATE', 'Data de Assinatura');
define( '_ACTIVE_TITLE', 'Assinaturas Ativas');
define( '_ACTIVE_DESC','Esta lista nao inclui assinaturas configuradas manualmente, apenas as processadas pelo PayPal.');
define( '_LASTPAY_DATE', 'Data ltimo Pagamento');
define( '_USERPLAN', 'Plano');
define( '_CANCELLED_TITLE', 'Assinaturas Canceladas');
define( '_CANCELLED_DESC', 'Esta lista nao inclui assinaturas confiradas manualmente, apenas as processadas pelo PayPal. So as assinaturas canceladas pelo usurio mas que ainda no expiraram.');
define( '_CANCEL_DATE', 'Data de Cancelamento');
define( '_MANUAL_DESC', 'Ao remover uma entrada, o usurio  removido totalmente da base de dados.');
...
define( '_CFG_TAB1_OPT1NAME', 'Perodo de Expiraco Inicial');
define( '_CFG_TAB1_OPT1DESC', 'Expiraco padro, em dias, para novos usurios. Isto  relativo a data de registro, portanto se voc deseja que novas contas sejam criadas j expiradas informe -1 (menos 1) aqui. Esta opco no tem efeito com registros que usam sistemas automticos de pagamento, como o PayPal.');
...
define( '_PEND_TITLE', 'Assinaturas Pendentes');
define( '_PEND_DESC', 'Assinaturas que ainda no completaram o processo. Isso  comum por um curto perodo de tempo enquanto o sistema aguarda a notificaco do PayPal (IPN).');
