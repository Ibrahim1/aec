...
define( '_CHECKOUT_INFO', 'Данные Вашей регистрации сохранены. На этой странице Вы можете произвести оплату. <br /> В случае сбоя при оплате Вы всегда сможете вернуться на эту страницу, воспользовавшись имеющимися логином и паролем и произвести оплату');

define( '_CHECKOUT_INFO_REPEAT', 'Спасибо, что вернулись. На этой странице Вы можете завершить платеж. <br /> В случае сбоя при оплате Вы всегда сможете вернуться на эту страницу, воспользовавшись имеющимися логином и паролем и произвести оплату');
