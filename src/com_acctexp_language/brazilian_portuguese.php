...
define( '_RENEW_LIFETIME', 'Voce tem uma assinatura eterna.');
define( '_RENEW_DAYSLEFT', 'Dias restantes');
define( '_RENEW_DAYSLEFT_TRIAL', 'Dias restantes em trial (avaliacao)');
define( '_RENEW_DAYSLEFT_EXCLUDED', 'Voce nao possui controle de expiracao');
define( '_RENEW_DAYSLEFT_INFINITE', '&#8734');
define( '_RENEW_INFO', 'Voce usa pagamentos recorrentes.');
...
define( '_YOUR_SUBSCRIPTION', 'Sua Assinatura');
define( '_YOUR_FURTHER_SUBSCRIPTIONS', 'Outras Assinaturas');
define( '_PLAN_PROCESSOR_ACTIONS', 'Para isso, voce tem as seguintes opcoes:');
define( '_AEC_SUBDETAILS_TAB_OVERVIEW', 'Visao Geral');
define( '_AEC_SUBDETAILS_TAB_INVOICES', 'Ordens');
