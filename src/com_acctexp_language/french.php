...
define( '_CHECKOUT_INFO', 'Vos informations ont &eacute;t&eacute; sauvegard&eacute;es. Afin d\'utiliser votre nouveau compte, vous devez effectuer votre r&egrave;glement via une passerelle de paiement en cliquant sur le bouton ci-dessous. <br /> Si un probl&egrave;me arrive durant la proc&eacute;dure, vous pouvez toujours revenir en arri&egrave;re, &agrave; cette &eacute;tape en vous connectant &agrave; notre site - Notre syst&egrave;me vous proposera de r&eacute;essayer le paiement.');
define( '_CHECKOUT_INFO_REPEAT', 'Merci d\'&ecirc;tre revenu. Pour effectuer votre r&egrave;glement, vous devez vous rendre sur la passerelle de paiement en cliquant sur le bouton ci-dessous. <br /> Si un probl&egrave;me arrive durant la proc&eacute;dure, vous pouvez toujours revenir en arri&egrave;re, &agrave; cette &eacute;tape en vous connectant &agrave; notre site - Notre syst&egrave;me vous proposera de r&eacute;essayer le paiement.');
define( '_CHECKOUT_INFO_TRANSFER', 'Vos informations ont &eacute;t&eacute; sauvegard&eacute;es. Afin d\'utiliser votre nouveau compte, vous devez suivre les &eacute;tapes ci-dessous. <br /> Si un probl&egrave;me arrive durant la proc&eacute;dure, vous pouvez toujours revenir en arri&egrave;re, &agrave; cette &eacute;tape en vous connectant &agrave; note site avec vos nouveaux renseignements - Notre Syst&egrave;me vous redonnera la chance de revoir cette page.');
define( '_CHECKOUT_INFO_TRANSFER_REPEAT', 'Merci d\'&ecirc;tre revenu. Pour effectuer votre r&egrave;glement, vous devez proc&eacute;der comme indiqu&eacute; ci-dessous. <br /> Si un probl&egrave;me arrive durant la proc&eacute;dure, vous pouvez toujours revenir en arri&egrave;re, &agrave; cette &eacute;tape en vous connectant &agrave; notre site - Notre syst&egrave;me vous proposera de r&eacute;essayer le paiement.');
