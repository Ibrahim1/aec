...
define( '_MI_MI_PHPBB3_GROUP_NAME','phpBB3 group to apply member to on application' );
...
define( '_MI_MI_PHPBB3_GROUP_EXP_NAME','phpBB3 group to apply member to on expiration of plan.' );
