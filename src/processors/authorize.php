...
class processor_authorize extends POSTprocessor
{
	...
	function createGatewayLink( $request )
	{
		...
		$var['x_receipt_link_url']		= AECToolbox::deadsureURL("index?option=com_acctexp&amp;task=authorizenotification");
		$var['x_receipt_link_text']		= "Continue";
		$var['x_show_form']				= "PAYMENT_FORM";
		//$var['x_relay_response']		= "True";
		//$var['x_relay_url']			= AECToolbox::deadsureURL('index?option=com_acctexp&task=authnotification');
