...
// Paypal Settings
DEFINE ('_CFG_PAYPAL_BUSINESS_NAME', 'ID da Conta PayPal:');
DEFINE ('_CFG_PAYPAL_BUSINESS_DESC', 'Sua identificaco de Merchant (email) no PayPal.');
...
DEFINE ('_CFG_PAYPAL_SUBSCRIPTION_BUSINESS_NAME', 'ID da Conta PayPal:');
DEFINE ('_CFG_PAYPAL_SUBSCRIPTION_BUSINESS_DESC', 'Sua identificaco de Merchant (email) no PayPal.');
...
DEFINE ('_CFG_TRANSFER_ENABLE_NAME', 'Permitir Pagamentos Alternativos?');
DEFINE ('_CFG_TRANSFER_ENABLE_DESC', 'Selecione Sim para oferecer ao usurio uma forma alternativa de pagamento, como transferncia bancria ou depsito em conta. O usurio que est se registrando ver as instruces fornecidas por voc, atravs do campo abaixo, de como efetuar o pagamento. Para essa forma de pagamento no h processamento automtico, portanto voc dever configurar a data de expiraco da conta manualmente atravs da interface de administrador.');
DEFINE ('_CFG_TRANSFER_INFO_NAME', 'Informaco para Pagamento Alternativo:');
DEFINE ('_CFG_TRANSFER_INFO_DESC', 'Texto para ser apresentado ao usurio aps o seu registro inicial (use tags HTML). Preencha instruces para pagamento, tais como o banco e conta para depsito ou transferncia. Aps o registro, no primeiro logon do usurio, a expiraco padro (definida na primeira aba) ser configurada para a conta do usurio. Voc dever confirmar o pagamento por meios manuais e configurar a expiraco da conta do usurio.');
