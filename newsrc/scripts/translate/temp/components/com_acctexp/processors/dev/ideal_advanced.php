...
class processor_ideal_advanced extends XMLprocessor
{
	function info()
	{
		...
		$i['longname']		= JText::_('CFG_IDEAL_ADVANCED_LONGNAME');
		$i['statement']		= JText::_('CFG_IDEAL_ADVANCED_STATEMENT');
		$i['description']	= JText::_('CFG_IDEAL_ADVANCED_DESCRIPTION');
		$i['currencies']	= 'EUR';
		$i['languages']		= 'NL';
	...
	function settings()
	{
		...
		$s['bank']			= "ING";
		$s['language']		= "NL";
		$s['description']	= sprintf( JText::_('CFG_PROCESSOR_ITEM_NAME_DEFAULT'), '[[cms_live_site]]', '[[user_name]]', '[[user_username]]' );
	...
	function checkoutform( $request )
	{
		...
		$var['params']['billFirstName']		= array( 'inputC', JText::_('AEC_USERFORM_BILLFIRSTNAME_NAME'), JText::_('AEC_USERFORM_BILLFIRSTNAME_NAME'), $name[0]);
		$var['params']['billLastName']		= array( 'inputC', JText::_('AEC_USERFORM_BILLLASTNAME_NAME'), JText::_('AEC_USERFORM_BILLLASTNAME_NAME'), $name[1]);

		if ( !empty( $this->settings['promptAddress'] ) ) {
			$var['params']['billAddress'] = array( 'inputC', JText::_('AEC_USERFORM_BILLADDRESS_NAME') );
			$var['params']['billCity'] = array( 'inputC', JText::_('AEC_USERFORM_BILLCITY_NAME') );
			$var['params']['billState'] = array( 'inputC', JText::_('AEC_USERFORM_BILLSTATE_NAME') );
			$var['params']['billZip'] = array( 'inputC', JText::_('AEC_USERFORM_BILLZIP_NAME') );
			$var['params']['billCountry'] = array( 'inputC', JText::_('AEC_USERFORM_BILLCOUNTRY_NAME') );
		}
