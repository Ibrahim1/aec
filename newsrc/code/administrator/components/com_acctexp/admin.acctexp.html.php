							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									foreach ( $m['items'] as $item ) {
										if ( is_array( $item ) ) {
											echo '<li><a id="aecmenu-' . str_replace( " ", "-", strtolower( $item[1] ) ) . '" href="' . $linkroot.$item[0] . '">' . $item[2] . '</a></li>';
										} else {
				...
				<div id="aec-center">
					<div class="aec-center-block col-md-8">
						<table class="diorama">
							...
							<tr>
								<td><div class="cell-wrapper"><?php HTML_AcctExp::quickiconButton( $linkroot.'index&entity=ItemGroup', 'itemgroups', JText::_('AEC_CENTR_GROUPS') ) ?></div></td>
			...
			<div class="row">
				<div style="background: #000;" class="col-sm-8">
					...
					<div class="installnote">
						...
						<h1>Graphics</h1>
						<p>All layout and graphics design as well as images are <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">CC-BY-NC-SA 3.0</a> 2006-2015 David 'skOre' Deutsch unless otherwise noted.</p>
