...
define( '_AEC_SEL_HOLD',						'Wartestellung' );
define( '_AEC_SEL_NOT_CONFIGURED',				'Keine Mitgliedschaft' );
...
define( '_EOT_DESC', 'Diese Liste enth&auml;lt nur Abonnements, die durch Online-Zahlung abgeschlossen wurden. Das L&ouml;schen eines Eintrages l&ouml;scht den betreffenden Benutzer aus der Datenbank und seine Eintr&auml;ge im Zahlungsverlauf.' );
...
define( '_ACTIVE_DESC', 'Diese Liste enth&auml;lt nur Abonnements, die durch ein Zahlungsgateway abgeschlossen wurden.' );
define( '_LASTPAY_DATE', 'Datum der letzten Zahlung' );
define( '_USERPLAN', 'Plan' );
define( '_CANCELLED_TITLE', 'Abgebrochene Abonnements' );
define( '_CANCELLED_DESC', 'Diese Liste enth&auml;lt keine nur Abonnements, die durch ein Zahlungsgateway abgeschlossen wurden. Es sind die Abonnements, die von den Benutzern abgebrochen wurden, aber noch nicht ausgelaufen sind.' );
...
define( '_PAYPLAN_PARAMS_UPDATE_EXISTING_NAME', 'Bestehende Mitgliedschaft updaten:');
