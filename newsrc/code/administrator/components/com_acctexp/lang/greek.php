...
* @subpackage Language - Backend - Greek
...
define( '_AEC_LANGUAGE',						'el' ); // DO NOT CHANGE!!
...
define( '_AEC_SPEC_MENU_ENTRY',					'Οι Συνδρομές μου' ); // 
...
define( '_AEC_CMN_YES',							'Ναί' ); // Yes
define( '_AEC_CMN_NO',							'Όχι' ); // No
...
// headers
define( '_AEC_HEAD_SETTINGS',					'Ρυθμίσεις' ); // Settings
...
define( '_AEC_CENTR_SETTINGS',					'Ρυθμίσεις' ); // Settings
...
define( '_PAYPLAN_DETAIL', 'Ρυθμίσεις'); // Settings
