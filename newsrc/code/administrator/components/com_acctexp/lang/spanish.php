...
define( '_AEC_LANGUAGE',						'es' ); // DO NOT CHANGE!!
...
define( '_REMOVE','Mover a la lista de excluidos');
define( '_CNAME','Nombre');
define( '_USERLOGIN','Login');
define( '_EXPIRATION','Expiracion');
define( '_USERS','Usuarios');
define( '_DISPLAY','Mostrar');
define( '_NOTSET','Excluidos');
define( '_SAVE','Grabar');
define( '_CANCEL','Cancelar');
define( '_EXP_ASC','Expiracion Asc');
define( '_EXP_DESC','Expiracion Desc');
define( '_NAME_ASC','Nombre Asc');
define( '_NAME_DESC','Nombre Desc');
...
define( '_REMOVED', 'Item removido de la lista.');
define( '_EOT_TITLE', 'Suscripciones Cerradas');
define( '_EOT_DESC', 'Esta lista incluye UNICAMENTE las suscripciones procesadas por PayPal. Cuando usted borre una entrada, el usuario sera removido de la base de datos junto con todas sus actividades relacionadas con la tabla historica local de PayPal.');
define( '_EOT_DATE', 'Fin de termino de fecha');
define( '_EOT_CAUSE', 'Causa');
define( '_EOT_CAUSE_FAIL', 'Falta del pago');
define( '_EOT_CAUSE_BUYER', 'Cancelado por usuario');
define( '_EOT_CAUSE_FORCED', 'Cancelado por administrador');
define( '_REMOVE_CLOSED', 'Borrar Usuario');
define( '_FORCE_CLOSE', 'Forzar Desuscripcion');
...
define( '_PAYPLAN_A3', 'Calificar');
define( '_PAYPLAN_P3', 'Periodo');
define( '_PAYPLAN_T3', 'Unidad de Periodo');
define( '_PAYPLAN_USERCOUNT', 'Suscriptores');
...
define( '_ALTERNATIVE_PAYMENT', 'Transferencia Bancaria');
define( '_SUBSCR_DATE', 'Fecha De Suscripcion');
define( '_ACTIVE_TITLE', 'Suscripciones Activas');
define( '_ACTIVE_DESC','Esta lista no incluye las suscripciones creadas a mano, solo las procesadas por PayPal.');
define( '_LASTPAY_DATE', 'Ultima Fecha De Pago');
define( '_USERPLAN', 'Plan');
define( '_CANCELLED_TITLE', 'Suscripciones Canceladas');
define( '_CANCELLED_DESC', 'Esta Lista no incluye las suscripciones creadas a mano, solamente las procesadas por PayPal. Estas son las suscripciones canceladas por los usuarios pero tenga en cuenta que no han caducado todavia.');
define( '_CANCEL_DATE', 'Fecha De Cancelacion');
define( '_MANUAL_DESC', 'Cuando usted borre una entrada, el usuario sera removido de la base de datos.');
...
define( '_CFG_TAB1_TITLE', 'Ociones de configuracion');
define( '_CFG_TAB1_SUBTITLE', 'Opciones para la interaccion con el usuario');
