...
jQuery.fn.daterangepicker = function(settings){
	...
	public function clickActions(el, rp, rpPickers, doneBtn){
		...
		if(el.is('.ui-daterangepicker-specificDate')){
			...
			rp.find('.range-start').datepicker('setDate', rangestart);
			...
			rp.find('.range-start').datepicker('setDate', rangestart);
			rp.find('.range-end').datepicker('setDate', rangeend);
	...
	rpPickers.find('.range-start').datepicker(options.datepickerOptions);
	rpPickers.find('.range-end').datepicker(options.datepickerOptions);
