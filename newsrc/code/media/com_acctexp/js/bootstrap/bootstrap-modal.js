  ...
  * ===================== */
  ...
  function backdrop ( callback ) {
    ...
    if ( this.isShown && this.settings.backdrop ) {
      ...
      jQuery.support.transition && this.$element.hasClass('fade')?
        this.$backdrop.one(transitionEnd, jQuery.proxy(removeBackdrop, this)) :
  ...
  * ========================== */
  ...
  jQuery(document).ready(function () {
    jQuery('body').delegate('[data-controls-modal]', 'click', function (e) {
      e.preventDefault()
      var $this = jQuery(this).data('show', true)
      jQuery('#' + $this.attr('data-controls-modal')).modal( $this.data() )
    })
  })
