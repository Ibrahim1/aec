...
!function( jQuery ){
  ...
  * ====================== */
  ...
  var Modal = function ( content, options ) {
    this.options = jQuery.extend({}, jQuery.fn.modal.defaults, options)
  ...
  * ===================== */
  ...
  function backdrop( callback ) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      jQuery.support.transition && this.$element.hasClass('fade')?
        this.$backdrop.one(jQuery.support.transition.end, jQuery.proxy(removeBackdrop, this)) :
  ...
  jQuery(function () {
    jQuery('body').on('click.modal.data-api', '[data-toggle="modal"]', function ( e ) {
      var $this = jQuery(this), href
        ...
        , option = $target.data('modal') ? 'toggle' : jQuery.extend({}, $target.data(), $this.data())
...
!function( jQuery ){
  ...
  * ========================= */
  ...
  jQuery(function () {
    ...
    jQuery('body').on('click.dropdown.data-api', toggle, Dropdown.prototype.toggle)
  })
...
!function ( $ ) {
  ...
  function ScrollSpy( element, options) {
    ...
    this.selector = (this.options.target
      ...
      || '') + ' .nav li > a'
    this.$body = jQuery('body').on('click.scroll.data-api', this.selector, process)
    this.refresh()
    this.process()
  }
    ...
    , refresh: function () {
        this.targets = this.$body
          ...
          .map(function () {
            ...
            return /^#\w/.test(href) && jQuery(href).length ? href : null
          })

        this.offsets = jQuery.map(this.targets, function (id) {
  ...
  * =============================== */
  ...
  , init: function ( type, element, options ) {
      ...
      if (this.options.trigger != 'manual') {
        ...
        this.$element.on(eventIn, this.options.selector, jQuery.proxy(this.enter, this))
        this.$element.on(eventOut, this.options.selector, jQuery.proxy(this.leave, this))
      }
...
!function( jQuery ) {
 ...
 "use strict"
  ...
  , setContent: function () {
      ...
      $tip.find('.popover-title')[ jQuery.type(title) == 'object' ? 'append' : 'html' ](title)
      $tip.find('.popover-content > *')[ jQuery.type(content) == 'object' ? 'append' : 'html' ](content)
  ...
  * ================= */
  ...
  jQuery(function () {
    jQuery('body').on('click.carousel.data-api', '[data-slide]', function ( e ) {
      var $this = jQuery(this), href
        , $target = jQuery($this.attr('data-target') || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+$)/, '')) //strip for ie7
        , options = !$target.data('modal') && jQuery.extend({}, $target.data(), $this.data())
...
!function( jQuery ){
  ...
  , listen: function () {
      ...
      if (jQuery.browser.webkit || jQuery.browser.msie) {
        this.$element.on('keydown', jQuery.proxy(this.keypress, this))
      }
