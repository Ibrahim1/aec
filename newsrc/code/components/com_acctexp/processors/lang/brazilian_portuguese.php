...
define( '_AEC_USERFORM_BILLFIRSTNAME_DESC', 'Nome');
define( '_AEC_USERFORM_BILLLASTNAME_NAME', 'Sobrenome');
define( '_AEC_USERFORM_BILLLASTNAME_DESC', 'Sobrenome');
define( '_AEC_USERFORM_BILLADDRESS_NAME', 'Endereço');
define( '_AEC_USERFORM_BILLADDRESS_DESC', 'Endereço');
define( '_AEC_USERFORM_BILLADDRESS2_NAME', 'Número');
define( '_AEC_USERFORM_BILLADDRESS2_DESC', 'Número');
define( '_AEC_USERFORM_BILLCITY_NAME', 'Cidade');
define( '_AEC_USERFORM_BILLCITY_DESC', 'Cidade');
