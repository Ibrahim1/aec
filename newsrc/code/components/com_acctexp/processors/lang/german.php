...
define( '_AEC_USERFORM_BILLFIRSTNAME_DESC', 'Vorname');
define( '_AEC_USERFORM_BILLLASTNAME_NAME', 'Nachname');
define( '_AEC_USERFORM_BILLLASTNAME_DESC', 'Nachname');
define( '_AEC_USERFORM_BILLADDRESS_NAME', 'Adresse');
define( '_AEC_USERFORM_BILLADDRESS_DESC', 'Adresse');
define( '_AEC_USERFORM_BILLADDRESS2_NAME', 'Adresse (fortgesetzt)');
define( '_AEC_USERFORM_BILLADDRESS2_DESC', 'Adresse (fortgesetzt)');
define( '_AEC_USERFORM_BILLCITY_NAME', 'Stadt');
define( '_AEC_USERFORM_BILLCITY_DESC', 'Stadt');
