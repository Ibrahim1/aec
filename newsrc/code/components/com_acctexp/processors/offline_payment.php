...
class processor_offline_payment extends processor
{
	function info()
	{
		...
		$info['longname']		= JText::_('CFG_OFFLINE_PAYMENT_LONGNAME');
		$info['statement']		= JText::_('CFG_OFFLINE_PAYMENT_STATEMENT');
		$info['description']	= JText::_('CFG_OFFLINE_PAYMENT_DESCRIPTION');
