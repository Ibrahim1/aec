<?php
/**
 * @version $Id: offline_payment2.php
...
class processor_offline_payment2 extends processor
{
	function info()
	{
		$info = array();
		$info['name']			= 'offline_payment2';
		$info['longname']		= JText::_('CFG_OFFLINE_PAYMENT2_LONGNAME');
		$info['statement']		= JText::_('CFG_OFFLINE_PAYMENT2_STATEMENT');
		$info['description']	= JText::_('CFG_OFFLINE_PAYMENT2_DESCRIPTION');
