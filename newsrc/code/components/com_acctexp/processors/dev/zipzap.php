...
class processor_zipzap extends XMLprocessor
{
	...
	function checkoutform( $request )
	{
		...
		$var['params']['billFirstName'] = array( 'inputC', JText::_('AEC_ZIPZAP_PARAMS_BILLFIRSTNAME_NAME'), JText::_('AEC_ZIPZAP_PARAMS_BILLFIRSTNAME_NAME'), $firstfirstname );
		$var['params']['billLastName'] = array( 'inputC', JText::_('AEC_ZIPZAP_PARAMS_BILLLASTNAME_NAME'), JText::_('AEC_ZIPZAP_PARAMS_BILLLASTNAME_NAME'), $lastname );
