...
class processor_epay_usa extends POSTprocessor
{
	function info()
	{
		$info = array();
	...
	function createGatewayLink( $request )
	{
		if ( $this->settings['testmode'] ) {
			$var['post_url']	= "https://sandbox.usaepay.com/interface/epayform/52a8f3d1Ut6yss5juANQ/";
                        $var['UMkey']           = "52a8f3d1Ut6yQ1KxuANQ";                        
                           
		} else {
			$var['post_url']	= "https://secure.usaepay.com/interface/epayform/bQC545L1cu1tkjmy64/";
			$var['UMkey']           = "bQC545L1cu10p2A3Itkjmy64";
