<?php
/**
 * @version $Id: google_wallet.php
 * @package AEC - Account Control Expiration - Membership Manager
 * @subpackage Processors - Google Wallet
...
class processor_google_wallet extends XMLprocessor
{
	function info()
	{
		$info = array();
		$info['name']					= 'google_wallet';
		$info['longname']				= JText::_('CFG_GOOGLE_WALLET_LONGNAME');
		$info['statement']				= JText::_('CFG_GOOGLE_WALLET_STATEMENT');
		$info['description']			= JText::_('CFG_GOOGLE_WALLET_DESCRIPTION');
