...
class processor_worldpay_futurepay extends POSTprocessor
{
	function info()
	{
		...
		$info['longname']			= JText::_('_CFG_WORLDPAY_FUTUREPAY_LONGNAME');
		$info['statement']			= JText::_('_CFG_WORLDPAY_FUTUREPAY_STATEMENT');
		$info['description']		= JText::_('_CFG_WORLDPAY_FUTUREPAY_DESCRIPTION');
