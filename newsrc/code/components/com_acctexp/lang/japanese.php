 ...
 * @subpackage Language - Frontend - Japanese
...
define( '_MYSUBSCRIPTION_TITLE', 'アカウント詳細');
define( '_MEMBER_SINCE', 'Member since');
define( '_HISTORY_COL1_TITLE', '請求書');
define( '_HISTORY_COL2_TITLE', '金額');
define( '_HISTORY_COL3_TITLE', '支払日');
define( '_HISTORY_COL4_TITLE', '支払方法');
define( '_HISTORY_COL5_TITLE', 'Action');
define( '_HISTORY_COL6_TITLE', 'プラン');
define( '_HISTORY_ACTION_REPEAT', 'pay');
define( '_HISTORY_ACTION_CANCEL', 'cancel');
define( '_RENEW_LIFETIME', 'あなたのプランは有効期限がありません。');
define( '_RENEW_DAYSLEFT_EXCLUDED', 'このプランは有効期限がありません。');
...
define( '_RENEW_BUTTON_UPGRADE', 'アップグレ－ド/更新');
...
define( '_YOUR_SUBSCRIPTION', 'Your Membership');
...
define( '_AEC_SUBDETAILS_TAB_OVERVIEW', '概要');
define( '_AEC_SUBDETAILS_TAB_INVOICES', '請求書');
define( '_AEC_SUBDETAILS_TAB_DETAILS', '詳細');

define( '_HISTORY_ACTION_PRINT', '印刷');
define( '_INVOICEPRINT_DATE', '日付');
define( '_INVOICEPRINT_ID', 'ID');
define( '_INVOICEPRINT_REFERENCE_NUMBER', 'Reference Number');
define( '_INVOICEPRINT_ITEM_NAME', 'アイテム');
define( '_INVOICEPRINT_UNIT_PRICE', '価格');
define( '_INVOICEPRINT_QUANTITY', '数');
define( '_INVOICEPRINT_TOTAL', '小計');
define( '_INVOICEPRINT_GRAND_TOTAL', '合計');

define( '_INVOICEPRINT_ADDRESSFIELD', 'Enter your Address here - it will then show on the printout.');
define( '_INVOICEPRINT_PRINT', '印刷');
...
define( '_AEC_PROMPT_PASSWORD_BUTTON', '次へ');
...
// --== THANK YOU PAGE ==--
define( '_THANKYOU_TITLE', 'ありがとうございました！');
define( '_SUB_FEPARTICLE_HEAD', 'Subscription Complete!');
define( '_SUB_FEPARTICLE_HEAD_RENEW', 'Subscription Renew Complete!');
define( '_SUB_FEPARTICLE_LOGIN', '今すぐにログインすることができます。');
define( '_SUB_FEPARTICLE_THANKS', 'ご登録ありがとうございます。');
...
define( 'COUNTRYCODE_SELECT', '国を選択' );
