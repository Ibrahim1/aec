 ...
 * @subpackage Language - Frontend - Greek
...
define( '_AEC_EXPIRE_TODAY',				'Αυτός ο λογαριασμός είναι ενεργός μέχρι και σήμερα' ); // This account is active until today
define( '_AEC_EXPIRE_FUTURE',				'Αυτός ο λογαριασμός είναι ενεργός μέχρι' ); // This account is active until
define( '_AEC_EXPIRE_PAST',					'Ο λογαριασμός αυτός ισχύει μέχρι' ); // This account was valid until
define( '_AEC_DAYS_ELAPSED',				'ημέρα(ες) που απομένει(ουν)'); // day(s) elapsed
...
define( '_AEC_EXPIRE_NOT_SET',				'Δεν έχει οριστεί' ); // Not Set
...
// --== PAYMENT PLANS PAGE ==--
define( '_PAYPLANS_HEADER', 'Επιλέξτε το επιθυμητό πλάνο'); // Payment Plans
