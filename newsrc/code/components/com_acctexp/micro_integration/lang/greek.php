<?php
/**
 * @version $Id: greek.php
 * @package AEC - Account Control Expiration - Membership Manager
 * @subpackage Language - MicroIntegrations - Greek
 * @copyright 2006-2011 Copyright (C) David Deutsch
 * @author David Deutsch <skore@skore.de> & Team AEC - http://www.valanx.org
 * @translation by Alexandros Seitaridis <alexandros@seitaridis.gr> & OLKOS.networks Team - http://www.olkos.net
...
define( '_MI_MI_EMAIL_CC_NAME',						'CC Recipient(s)' );
define( '_MI_MI_EMAIL_CC_DESC',						'CC Recipients for this email. Separate with comma. The rewriting routines explained below will work for this field.' );
define( '_MI_MI_EMAIL_BCC_NAME',					'BCC Recipient(s)' );
define( '_MI_MI_EMAIL_BCC_DESC',					'BCC Recipients for this email. Separate with comma. The rewriting routines explained below will work for this field.' );
define( '_MI_MI_EMAIL_SUBJECT_NAME',				'Subject' );
define( '_MI_MI_EMAIL_SUBJECT_DESC',				'Subject of this email (Uses RewriteEngine as explained below)' );
...
define( '_MI_MI_EMAIL_SUBJECT_FIRST_DESC',			'Subject of this email only when a user first signs up (Uses RewriteEngine as explained below)' );
...
define( '_MI_MI_EMAIL_SUBJECT_EXP_DESC',			'Expiration Subject (Uses RewriteEngine as explained below)' );
...
define( '_MI_MI_EMAIL_SUBJECT_PRE_EXP_DESC',		'Pre Expiration Subject (Uses RewriteEngine as explained below)' );
...
define( '_MI_MI_COUPON_SUBJECT_DESC',				'Subject of this email (Uses RewriteEngine as explained below)' );
...
define( '_MI_MI_EMAIL_FILES_CC_NAME',			'CC Recipient(s)' );
define( '_MI_MI_EMAIL_FILES_CC_DESC',			'CC Recipients for this email. Separate with comma. The rewriting routines explained below will work for this field.' );
define( '_MI_MI_EMAIL_FILES_BCC_NAME',			'BCC Recipient(s)' );
define( '_MI_MI_EMAIL_FILES_BCC_DESC',			'BCC Recipients for this email. Separate with comma. The rewriting routines explained below will work for this field.' );
define( '_MI_MI_EMAIL_FILES_SUBJECT_NAME',		'Subject' );
define( '_MI_MI_EMAIL_FILES_SUBJECT_DESC',		'Subject of this email (Uses RewriteEngine as explained below)' );
...
define( '_MI_MI_EMAIL_MULTI_CC_NAME',			'#%s: CC Recipient(s)' );
define( '_MI_MI_EMAIL_MULTI_CC_DESC',			'CC Recipients for this email. Separate with comma. The rewriting routines explained below will work for this field.' );
...
define( '_MI_MI_AECUSERDETAILS_SETTINGS_NAME',		'Ρυθμίσεις' ); // Settings
