<?php
/**
 * @version $Id: mi_ultratransport.php
 * @package AEC - Account Control Expiration - Membership Manager
 * @subpackage Micro Integrations - ultratransport
...
class mi_ultratransport
{
	public function Info()
	{
		$info = array();
		$info['name'] = JText::_('AEC_MI_ULTRATRANSPORT_NAME');
		$info['desc'] = JText::_('AEC_MI_ULTRATRANSPORT_DESC');
	...
	public function createQuery( $fields, $table )
	{
		...
		$query  = 'INSERT INTO #__ultratransport_' . $table
	...
	public function getCompanyByName( $name )
	{
		...
		$query = 'SELECT id FROM #__ultratransport_companies'
	...
	public function getObject( $table, $field, $id )
	{
		...
		$query = 'SELECT * FROM #__ultratransport_' . $table
	...
	public function storeObject( $object, $table )
	{
		...
		$query  = 'UPDATE #__ultratransport_' . $table
				. ' SET ' . implode(', ', $updates ) . ' '
	...
	public function getProperties( $agentid )
	{
		...
		$query = 'SELECT prop_id'
				. ' FROM #__ultratransport_agentmid'
