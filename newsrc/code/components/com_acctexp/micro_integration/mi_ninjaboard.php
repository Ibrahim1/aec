...
define( '_AECJText::_('_MI_NAME')_NINJABOARD', 'Ninjaboard' );
define( '_AECJText::_('_MI_DESC')_NINJABOARD', 'Assign Groups in Ninjaboard' );
...
class mi_ninjaboard
{
	...
	{
		$info = array();
		$info['name'] = _AECJText::_('_MI_NAME')_NINJABOARD;
		$info['desc'] = _AECJText::_('_MI_DESC')_NINJABOARD;
	...
	function getLang()
	{
		foreach( array(
			...
			'_MI_MI_NINJABOARD_SETJText::_('_REMOVE')_GROUP_NAME',
			'_MI_MI_NINJABOARD_SETJText::_('_REMOVE')_GROUP_DESC',
			'_MI_MI_NINJABOARDJText::_('_REMOVE')_GROUP_NAME',
			'_MI_MI_NINJABOARDJText::_('_REMOVE')_GROUP_DESC',
			'_MI_MI_NINJABOARD_SET_GROUP_EXP_NAME',
			'_MI_MI_NINJABOARD_SET_GROUPJText::_('_EXP_DESC')',
			'_MI_MI_NINJABOARD_GROUP_EXP_NAME',
			'_MI_MI_NINJABOARD_GROUPJText::_('_EXP_DESC')',
			'_MI_MI_NINJABOARD_SETJText::_('_REMOVE')_GROUP_EXP_NAME',
			'_MI_MI_NINJABOARD_SETJText::_('_REMOVE')_GROUPJText::_('_EXP_DESC')',
			'_MI_MI_NINJABOARDJText::_('_REMOVE')_GROUP_EXP_NAME',
			'_MI_MI_NINJABOARDJText::_('_REMOVE')_GROUPJText::_('_EXP_DESC')',
